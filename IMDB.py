...
st.set_page_config(
    page_title="IMDB Movie Analysis With PowerBI",
    layout="wide",
    initial_sidebar_state="expanded"
)
df = pd.read_csv('/Users/shivamtiwari/Desktop/Guvi_Projects/IMDB Movie Analysis/IMDB_Movies.csv')
...
if selected == 'Home':
    ...
    st.title(":red[*IMDB Movie Analysis With PowerBI*]")
    ...
    with col1:
        col1.markdown("# ")
        col1.markdown("# ")
        col1.markdown("## :blue[*Overview*] : Creating a dashboard with PowerBI/Tableau to analyze movie data")
        col1.markdown("# ")
        col1.markdown("## :blue[*Domain*] : Movie")
        col1.markdown("# ")
        col1.markdown("## :blue[*Technologies used*] : Python, Pandas, Numpy, Matplotlib, Seaborn, Streamlit, Tableau.")

    with col2:
        col2.markdown("# ")
        col2.markdown("# ")
        col2.image("/Users/shivamtiwari/Downloads/imdb.png")
        col2.markdown("# ")
        col2.image("/Users/shivamtiwari/Downloads/movie.jpeg")
        col2.markdown("# ")
        col2.image("/Users/shivamtiwari/Downloads/images.jpeg")

if selected == 'Movie Analysis':

    st.title(":green[*Movie Analysis FAQ*]")
    ...
    if questions == "01. Why do movies with higher budgets tend to have higher ratings?":
        ...
        col1, col2 = st.columns(2)
        col1.markdown("# ")
        col1.image("/Users/shivamtiwari/Downloads/budget.jpeg")
        col2.markdown("# ")
        col2.markdown("# ")
        col2.image("/Users/shivamtiwari/Downloads/productivity.jpeg")
    ...
    if questions == "02. Why does better production quality lead to higher ratings?":
        ...
        col1.markdown("# ")
        col1.markdown("# ")
        col1.image("/Users/shivamtiwari/Downloads/product.jpeg")
        col2.markdown("# ")
        col2.image("/Users/shivamtiwari/Downloads/rating.jpeg")
    ...
    if questions == "03. Why does an enhanced viewer experience lead to higher ratings?":
        ...
        col1, col2 = st.columns(2)
        col1.markdown("# ")
        col1.image("/Users/shivamtiwari/Downloads/emotion .jpeg")
        col2.markdown("# ")
        col2.image("/Users/shivamtiwari/Downloads/rating-2.png")
    ...
    if questions == "04. Why are viewers more likely to rate a movie highly if they enjoyed watching it?":
        ...
        col1, col2 = st.columns(2)
        col1.markdown("# ")
        col1.image("/Users/shivamtiwari/Downloads/emotion 2.jpeg")
        col2.markdown("# ")
        col2.image("/Users/shivamtiwari/Downloads/rating-3.jpeg")
    ...
    if questions == "05. Why do positive reviews matter?":
        ...
        col1.markdown("# ")
        col1.markdown("# ")
        col1.image("/Users/shivamtiwari/Downloads/customer .jpeg")
        col2.markdown("# ")
        col2.image("/Users/shivamtiwari/Downloads/success.jpeg")
